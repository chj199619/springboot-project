...
public class Computer {
    ...
    public Computer(int g_id, String g_img, String g_name, double g_price, String g_xiangqing, String g_color, String t_type, double g_oriprice, String g_neicun, int g_num, String g_hiredate) {
        this.g_id = g_id;
        this.g_img = g_img;
        this.g_name = g_name;
    ...
    public Computer(String g_img, String g_name, double g_price, String g_xiangqing, String g_color, String t_type, double g_oriprice, String g_neicun, int g_num, String g_hiredate) {
        this.g_img = g_img;
        this.g_name = g_name;
        this.g_price = g_price;
        this.g_xiangqing = g_xiangqing;
